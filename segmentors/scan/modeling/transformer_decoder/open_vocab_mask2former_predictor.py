...
from .mask2former_transformer_decoder import SCANMultiScaleMaskedTransformerDecoder, MLP


class OpenVocabMask2FormerPredictor(SCANMultiScaleMaskedTransformerDecoder):
    @configurable
    def __init__(
        self,
        in_channels,
