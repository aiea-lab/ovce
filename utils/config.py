...
def masqclip_config():
    ...
    # CUSTOM PARAMETERS (OUR)
    cfg.INPUT.MIN_SIZE = 512
    cfg.INPUT.MAX_SIZE = 2048
    cfg.MODEL.WEIGHTS = "data/model/segmentors/masqclip_cross_dataset.pth"
...
def cat_seg_config():
    ...
    cfg.MODEL.WEIGHTS = "data/model/segmentors/cat_seg_large.pth"
...
def openseed_config():
    ...
    # CUSTOM PARAMETERS (OUR)
    cfg.MODEL.WEIGHTS = "data/model/segmentors/openseed.pth"
    return cfg
...
def scan_config():
    ...
    cfg.INPUT.MIN_SIZE = 640
    cfg.INPUT.MAX_SIZE = 2560
    cfg.MODEL.WEIGHTS = "data/model/segmentors/SCAN.pth"
    cfg.freeze()
    return cfg
...
def sed_config():
    ...
    cfg.INPUT.MIN_SIZE = 640
    cfg.INPUT.MAX_SIZE = 2560
    cfg.MODEL.WEIGHTS = "data/model/segmentors/sed_model_large.pth"
...
def mask2former_config():
    ...
    #https://dl.fbaipublicfiles.com/maskformer/mask2former/coco/panoptic/maskformer2_swin_tiny_bs16_50ep/model_final_9fd0ae.pkl
    cfg.MODEL.MASK_FORMER.TEST.SEMANTIC_ON = True
    cfg.MODEL.MASK_FORMER.TEST.INSTANCE_ON = False
    cfg.MODEL.MASK_FORMER.TEST.PANOPTIC_ON = False
    ...
    cfg.INPUT.MAX_SIZE = 2048
    cfg.MODEL.WEIGHTS = "data/model/segmentors/mask2former.pkl"
    return cfg
