# Reference code https://github.com/KU-CVLAB/CAT-Seg/blob/main/cat_seg/data/datasets/register_ade20k_150.py
# Reference classes https://github.com/CSAILVision/sceneparsing/blob/master/objectInfo150.txt
import os
